...
get '/:email?' do
  ...
  @not_broken_examples = ["te.st@gmail.com", "test\+spamfilter@gmail.com", "test@gm.com", "test@ymail.com", "test@gmail.co.uk", "test@gmail.com.sg", "test@something.cn", "test@something.co", "test@something.coop", "test@something.gr", "test@something.net"]
  if params[:email] and params[:email].length > 0 and params[:email] != "favicon.ico"
