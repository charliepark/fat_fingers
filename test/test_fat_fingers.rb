...
class StringTest < MiniTest::Unit::TestCase
  def setup
    ...
    @good_gmail_with_dot_com = "test.com@gmail.com"
    @good_gmail_with_dot_com_more = "test.comisky@gmail.com"
    ...
    @good_comcast_com = "test@anything.comcast.com"
  ...
  def cases
    [ "aol", "aol_com", "att_net", "com", "comcast", "comcast_com", "comcastbiz_net", "facebook_com", "googlemail", "gm", "gmail", "gmail_with_dots", "gmail_with_plus", 
      "gmail_with_dot_com", "gmail_with_dot_com_more", "gao_gov", "gmx_com", "googlemail_com", "hotmail", "hotmail_co_uk", "icloud", "intl_gmail", 
      "live_com", "mac_com", "mail_com", "me_com", "mil", "msn_com", "net", "org", "outlook", "random_co", "sbcglobal", "tld_cn", "tld_co", "tld_coop", "tld_gr", "tld_jp", 
